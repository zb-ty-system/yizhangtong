...
*********************************************************************
*/
CREATE DATABASE IF NOT EXISTS`assetmng`;
...
CREATE TABLE `ams_asset_info` (
  ...
  `issuer_id` int(11) DEFAULT NULL COMMENT '发行机构ID',
  `issuer_name` varchar(32) DEFAULT NULL COMMENT '发行机构名称',
  `organizing_institution_code` varchar(32) DEFAULT NULL COMMENT '组织机构代码',
  ...
  `exchane_id` int(11) DEFAULT NULL COMMENT '交易所ID',
...
/*Data for the table `ams_asset_info` */
...
CREATE TABLE `ams_asset_pool` (
  ...
  `used_amount` decimal(16,4) DEFAULT NULL COMMENT '已使用金额',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `create_by` varchar(64) DEFAULT NULL COMMENT '创建人',
  `modify_time` datetime DEFAULT NULL COMMENT '修改时间',
  `modify_by` varchar(64) DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='资产资产池关联表';

/*Data for the table `ams_asset_pool` */
...
CREATE TABLE `ams_asset_sale_match` (
  ...
  `modify_by` varchar(64) DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='资产销售匹配表';

/*Data for the table `ams_asset_sale_match` */
...
CREATE TABLE `ams_pool_info` (
  ...
  `asset_amount` decimal(16,4) DEFAULT NULL COMMENT '总金额',
  `frozen_amount` decimal(16,4) DEFAULT NULL COMMENT '冻结金额',
  `sale_amount` decimal(16,4) DEFAULT NULL COMMENT '已销售金额',
  `stock` decimal(16,4) DEFAULT NULL COMMENT '库存',
  `status` tinyint(2) DEFAULT NULL COMMENT '状态 1.可使用，2已完成',
  `issuer_code` int(11) DEFAULT NULL COMMENT '发行机构编号(可能与原始资产不同)',
  ...
  `modify_by` varchar(64) DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='资产池信息表';

/*Data for the table `ams_pool_info` */
...
CREATE TABLE `ams_pool_product` (
  ...
  `modify_by` varchar(64) DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='资产池分配产品表';

/*Data for the table `ams_pool_product` */
...
CREATE TABLE `ams_product_order` (
  ...
  `modify_by` varchar(64) DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='资产销售订单表';
