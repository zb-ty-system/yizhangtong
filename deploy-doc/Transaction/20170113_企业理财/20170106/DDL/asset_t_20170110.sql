...
CREATE TABLE `patp_account_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='用户账户信息表';
...
CREATE TABLE `patp_invest_confirm` (
  ...
  `status` varchar(8) DEFAULT NULL COMMENT '状态1待确认2已确认0失败3已归档',
  `version` int(11) DEFAULT NULL COMMENT '版本',
  `memo` varchar(1024) DEFAULT NULL COMMENT '备注',
  `create_time` datetime DEFAULT NULL,
  `create_by` varchar(64) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8 COMMENT='申购确认表';
...
CREATE TABLE `patp_invest_request` (
  ...
  `status` varchar(8) DEFAULT NULL COMMENT '状态1新申请2待确认3成功4失败5已赎回',
...
) ENGINE=InnoDB AUTO_INCREMENT=192 DEFAULT CHARSET=utf8 COMMENT='申购请求表';
...
CREATE TABLE `patp_redeem_confirm` (
  ...
  `app_sheet_no` varchar(64) DEFAULT NULL,
  `status` varchar(8) DEFAULT NULL COMMENT '状态1待确认2成功0失败3已归档',
  `version` int(11) DEFAULT NULL COMMENT '版本',
  `memo` varchar(1024) DEFAULT NULL COMMENT '备注',
  `create_time` datetime DEFAULT NULL,
  `create_by` varchar(64) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_request_id` (`request_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=30189 DEFAULT CHARSET=utf8;
