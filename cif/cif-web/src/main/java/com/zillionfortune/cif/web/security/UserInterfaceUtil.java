package com.zillionfortune.cif.web.security;
...
public final class UserInterfaceUtil {
    ...
    private static final Logger log                   = LoggerFactory.getLogger(UserInterfaceUtil.class);
    ...
    public static List<String> getUserRoleByUserName(String username) {
        ...
        final String user_url = USERCENTER_PREFIX_URL + "/api/get/userRole/%s/new";
        List<String> list = new ArrayList<String>();
        try {
            String json = HttpClientUtil.sendGetRequest(String.format(user_url, username), null);
    ...
    public static Map<String, Object> getUserBaseInfo(String username) {
        ...
        try {
            String json = HttpClientUtil.sendGetRequest(user_url + username + "/" + sign + ".html", null);
