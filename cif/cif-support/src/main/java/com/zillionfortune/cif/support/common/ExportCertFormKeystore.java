 ...
 * 
 * @author litaiping
 * @version  ExportCertFormKeystore.java, v 0.1 2016-7-26 下午2:22:30
 */
public class ExportCertFormKeystore {
    ...
    public void genkey() {
        ...
        "cmd ", "/k", "start", // cmd Shell命令  
                ...
                "ss", "-keyalg", // -keyalg 指定密钥的算法 (如 RSA DSA（如果不指定默认采用DSA）)  
                "RSA", "-keystore", // -keystore指定存储位置，这里是d:/demo.keystore  
                "d:/demo.keystore", "-dname",// CN=(名字与姓氏), OU=(组织单位名称), O=(组织名称), L=(城市或区域名称),  
