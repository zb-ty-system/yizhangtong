package com.zillionfortune.cif.common.redis;
        ...
        try {
            ...
            do {
                ...
                if (i == 1) {
                    ...
                    log.debug("成功将" + lockKey + "锁定" + expire + "秒");
                    return Boolean.TRUE;
                } else { // 存在锁
                    if (log.isDebugEnabled()) {
                        log.debug("KEY值已经被锁定,等待");
                    }
                }
                if (timeout == 0) {
                    break;
